...
<!-- Main Sidebar Container -->
      <aside class="main-sidebar sidebar-light-pink elevation-6 sidebar-no-expand">
        <!-- Brand Logo -->
        <a href="<?php echo base_url ?>admin" class="brand-link bg-gradient-info text-sm">
    ...
    $(document).ready(function(){
      ...
      $('.nav-link.active').addClass('bg-gradient-info')
    })
  </script>